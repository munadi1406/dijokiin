...
export default function SecondHero() {
    ...
    return (
        <div className='flex justify-center items-center flex-col gap-2 w-full p-2  min-h-screen'>
            ...
            <Text className={"text-center md:w-2/3 w-full"}>Apa yang Anda Dapatkan dengan Layanan Bantuan Dari DIJokiin</Text>
            <p className='text-md  text-center capitalize '>Membantu Anda menyelesaikan tugas kuliah, pembuatan website untuk tugas kuliah, dan pengembangan aplikasi berbasis web untuk laporan magang atau skripsi dengan profesional dan efisien.</p>
